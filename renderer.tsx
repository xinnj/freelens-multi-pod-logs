...
export default class MultiPodLogsRenderer extends Renderer.LensExtension {
  ...
  onActivate() {
    console.log("freelens-multi-pod-logs renderer | activating...");
    sternPreferenceStore.loadExtension(this);
    console.log("freelens-multi-pod-logs renderer | activated");
  }

  // Disabling extension calls onDeactivate()
  onDeactivate() {
    console.log("freelens-multi-pod-logs renderer | de-activated");
  }
}
